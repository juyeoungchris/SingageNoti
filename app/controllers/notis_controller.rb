class NotisController < ApplicationController
	...
	def create
		...
		if @noti.save
		    ...
		    req.body = {to: "userId", data:{ type: "11" , scheduleTimeUTC: "0", timeoutSec: @noti.timeout.to_s , title: @noti.title , body: "http://13.125.195.134:3000/api/noti/" + @noti.id.to_s}}.to_json
